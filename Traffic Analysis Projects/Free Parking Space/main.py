...
while True:
    ...
    cv2.polylines(frame, [polygon_1], isClosed=True, color=green, thickness=thickness)
    cv2.polylines(frame, [polygon_2], isClosed=True, color=green, thickness=thickness)
    cv2.polylines(frame, [polygon_3], isClosed=True, color=green, thickness=thickness)
    cv2.polylines(frame, [polygon_4], isClosed=True, color=green, thickness=thickness)
    cv2.polylines(frame, [polygon_5], isClosed=True, color=green, thickness=thickness)
    cv2.polylines(frame, [polygon_6], isClosed=True, color=green, thickness=thickness)
